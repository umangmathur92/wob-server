...
/**
 * This represents the food web of all species. It builds a full web, and can
 * then return a partial web. The web may result in a set of graphs if the set
 * of species included does not overlap for predator and prey relationships.
 * 
