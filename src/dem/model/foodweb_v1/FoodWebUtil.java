...
/**
 * This is a set of utility functions for use by the Food Web. This represents
 * the food web as a graph by using standard Adjacency Lists of nodes for the
 * predators and prey. Each [predator, prey] relation and each [prey, preditor]
 * relation is a directed edge in an adjacency list.
 * 
 * @author Cheryl Nielsen for CSC 831 Multiplayer Game Development, San
 *         Francisco State University, Spring 2018
 */
