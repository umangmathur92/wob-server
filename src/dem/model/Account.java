...
/**
 * The Account class holds important information about the player including,
 * most importantly, the account. Such information includes the username,
 * password, email, and the player ID.
 */
public class Account {
	...
	public Account(int account_id, String email, String password, String salt, String username, String first_name,
			String last_name) {
		this.account_id = account_id;
		this.email = email;
