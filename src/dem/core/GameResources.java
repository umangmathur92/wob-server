...
public class GameResources {
	 ...
	 *
	 * @param player
	 *            references instance of the player
	 * @param amount
	 *            contains the amount of money given
	 */
	public static void updateCredits(Player player, int amount) {
		...
		NetworkFunctions.sendToPlayer(
				new ResponseUpdateResources(Constants.RESOURCE_COINS, amount, player.getCredits()), player.getID());
	}

	/**
	 * Adjusts a player's experience by the given amount. If the experience reaches
	 * a certain amount, their level is adjusted as well.
	 *
	 * @param player
	 *            references instance of the player
	 * @param amount
	 *            contains the amount of experience given
	 */
	public static void updateExperience(Player player, int amount) {
		...
		NetworkFunctions.sendToPlayer(
				new ResponseUpdateResources(Constants.RESOURCE_XP, amount, player.getExperience()), player.getID());
	}
}
