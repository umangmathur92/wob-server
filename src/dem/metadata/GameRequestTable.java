...
public class GameRequestTable {
	...
	public static void init() {
		...
		// add(NetworkCode.CLASH_SPECIES_LIST,
		// "cos.net.request.RequestClashSpeciesList");
		// add(NetworkCode.CLASH_DEFENSE_SETUP,
		// "cos.net.request.RequestClashDefenseSetup");
		...
		// add(NetworkCode.CLASH_INITIATE_BATTLE,
		// "cos.net.request.RequestClashInitiateBattle");
	 ...
	 * from its class name using reflection, by inserting the pair into the table.
	 *
	 * @param request_id
	 *            a value that uniquely identifies the request type
	 * @param name
	 *            a string value that holds the name of the request class
	 */
