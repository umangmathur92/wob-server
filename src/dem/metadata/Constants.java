...
public class Constants {
	...
	public final static int DEFAULT_SCORE_SMOOTHING_WINDOW_SIZE = 10; // Default number of days of raw score history to
																		// use for smoothing
	// Other
	...
	// public final static int TIMEOUT_MILLISECONDS = 900000000; //90000; - jtc,
	// using breakpoints, need more time
	...
	/*
	 * components of link parameter assimiliation rate and metrate; indices are
	 * MET_* constants, above
	 */
