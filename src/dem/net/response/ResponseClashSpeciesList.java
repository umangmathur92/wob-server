...
/**
 * Stores the list of species in Clash of Species to be sent back to the client
 * 
 * @author lev
 */
public class ResponseClashSpeciesList extends GameResponse {
	...
	/**
	 * Generates a byte array in the following format: id of this response (short) #
	 * of species returned (int) for each species: id (int) name (string) price
	 * (int) type (int, from a predetermined set) description (string) attack
	 * points, i.e. damage (int) hit points (int) movement speed (int) attack speed
	 * (int)
	 * 
