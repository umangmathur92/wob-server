...
/**
 * Data container for information needed when first enterirng the Clash of
 * Species game
 * 
 * @author lev
 */
public class ResponseClashEntry extends GameResponse {
	/**
	 * whether the user has a Clash of Species defense set up true if no defense
	 */
	private boolean isNewClashPlayer;

	/**
	 * Stores the species and positions of the defense, if it exists
	 */
	...
	/**
	 * Sets the boolean value for whether the user has a Clash of Species defense
	 * set up
	 * 
	 * @param isNewClashPlayer
	 *            true if no defense, false otherwise
	 */
	...
	/**
	 * Appends an element of the existing defense config: a species id and its
	 * position on the terrain
	 * 
	 * @param speciesId
	 *            the species id of the defense element
	 * @param positions
	 *            the list of vectors containing x and y-coordinates of the defense
	 *            element
	 */
	...
	/**
	 * Generates a byte array containing all the data to be sent to back to the
	 * client
	 * 
