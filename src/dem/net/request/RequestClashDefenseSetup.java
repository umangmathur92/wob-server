...
/**
 * Network request called when user wants to create or update his or her defense
 * configuration for the Clash of Species game
 * 
 * @author lev
 */
public class RequestClashDefenseSetup extends GameRequest {
	 ...
	 */
	private HashMap<Integer, ArrayList<Vector2<Float>>> configMap = new HashMap<Integer, ArrayList<Vector2<Float>>>();

	/**
	 * Fills the instance variables with data received over the network
	 * 
	 * @param dataInput
	 *            the input stream containg data sent by the client
	 * @throws IOException
	 */
	@Override
	...
	/**
	 * Checks the validity of the sent defense configuration If configuration was
	 * valid, saves the config in the database Sends the validity inside the
