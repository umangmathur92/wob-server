...
/**
 * Request for a list of players of Clash of Species Sent when the user has been
 * confirmed to possess a defense config and is entering the Clash game main
 * menu, where a list of players to challenge is displayed
 * 
 * @author lev
 */
public class RequestClashPlayerList extends GameRequest {
	...
	/**
	 * Generates a response containing a list of players of Clash of Species
	 * 
	 * @throws Exception
	 */
	@Override
