...
/**
 * Sent immediately after entry into the Clash of Species game Returns a list of
 * species available for use as defending or attacking elements in the game
 * 
 * @author lev
 */
public class RequestClashSpeciesList extends GameRequest {
	...
	/**
	 * Generates a response containing a list of species available for Clash of
	 * Species
	 * 
	 * @throws Exception
	 */
