...
public class DataReader {
	...
	/**
	 * Read a single short from the input stream. Used for Python client PyDatagram
	 * decoding.
	 *
	 * @param in
	 *            references the input stream
	...
	/**
	 * Read a single int from the input stream. Used for Python client PyDatagram
	 * decoding.
	 *
	 * @param in
	 *            references the input stream
	...
	/**
	 * Read a single string from the input stream. Used for Python client PyDatagram
	 * decoding.
	 *
	 * @param in
	 *            references the input stream
	...
	/**
	 * Read a single float from the input stream. Used for Python client PyDatagram
	 * decoding.
	 *
	 * @param in
	 *            references the input stream
