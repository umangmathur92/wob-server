...
public abstract class ExpTable {
	...
	/**
	 * Initializes the experience table by using the given formula and fill in the
	 * amount of experience that should be accumulated at every level.
	 */
	 ...
	 * 
	 * @param level
	 *            contains the level of the player
	...
	/**
	 * Calculates the amount of experience required to advance from one to the next
	 * by taking the difference of two levels.
	 * 
	 * @param level
	 *            contains the level of the player
	...
	/**
	 * Using the experience value, it will determine what is its equivalent level at
	 * the given amount of experience.
	 * 
	 * @param experience
	 *            is used to calculate its equivalent level
