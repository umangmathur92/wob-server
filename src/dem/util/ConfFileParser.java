...
public class ConfFileParser {
	...
	/**
	 * Initialize the parser with the filename for the formatted file to be parsed.
	 *
	 * @param fileName
	 *            a variable that holds the filename
	 */
			...
			while ((str = bur.readLine()) != null) {
				...
				while (st.hasMoreTokens()) {
					...
					if (i == 1) {
						...
						System.out.println("[In ConfFileParser.java]---There are more than 2 parts in a line in file: "
