...
public class GamePacketStream extends ByteArrayOutputStream {
	 ...
	 *
	 * @param short_val
	 *            contains the given value as short type
	 */
	 ...
	 *
	 * @param int_val
	 *            contains the given value as int type
	 */
	 ...
	 *
	 * @param int_val
	 *            contains the given value as long type
	 */
	...
	public byte[] toByteArray() {
		...
		// Log.consoleln("GamePacketStream size = " + this.size() + " vs (short) " +
		// (short) this.size());
