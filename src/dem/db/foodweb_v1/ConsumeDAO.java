...
/**
 * This retrieves the full set or a subset of the predator and prey
 * relationships from the "consume" table of the WoB database.
 * 
...
public class ConsumeDAO {
	...
	/**
	 * Returns the list of species that are predators for (will eat) the given
	 * species.
	 * 
	 */
	 ...
	 *            the database query
	 * @param getPrey
	 *            flag for returning prey list if true or predator list if false
