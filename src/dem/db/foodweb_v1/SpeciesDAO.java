...
/**
 * This retrieves particular plant or animal species from the "species" table of
 * the WoB database. However, it only gets a very limited subset of the
...
public class SpeciesDAO {
	 ...
	 * 
	 * @param sqlQuery
	 *            the SQL code for the database query
