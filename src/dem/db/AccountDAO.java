...
public final class AccountDAO {
	...
	/**
	 * Creates an account profile using the information as provided to the method
	 * into the database.
	 *
	 * @param email
	 *            contains the email used for the account
	 * @param password
	 *            contains the MD5-hashed password
	 * @param username
	 *            is the display name describing the user
	 * @param first_name
	 *            is the user's first name
	 * @param last_name
	 *            is the user's last name
	 * @param last_ip
	 *            contains the location by IP used to create the account
	 * @return the player ID generated from the database
	 */
	public static Account createAccount(String email, String password, String username, String first_name,
			String last_name, String last_ip) {
	...
	/**
	 * Retrieve account information from the database using both email and password.
	 *
	 * @param user_id
	 *            is used in combination with password to identify the account
	 * @param password
	 *            is used in combination with user_id to identify the account
	 ...
	 *
	 * @param email
	 *            is a string containing the email
	 ...
	 *
	 * @param account_id
	 *            used to identify the specific account
	 * @param address
	 *            holds the IP address in current use
	 * @return
	 */
	...
	/**
	 * Updates the database by recording the total time the account has been in use.
	 *
	 * @param account_id
	 *            used to identify the specific account
	 * @param play_time
	 *            holds the total time the account has been logged in
	 * @param active_time
	 *            holds the total time being active
	 * @return
	 */
	...
	/**
	 * Updates the database by recording the name of mini game player is playing.
	 *
	 * @param account_id
	 *            used to identify the specific account
	 * @param game_name
	 *            holds the name of the game that player is playing.
	 * @return
	 */
	 ...
	 *            used to identify the specific account
	 * @param in_game
	 *            holds the value of whether the player is playing a mini game or
	 *            not.
	 * @return
	 */
